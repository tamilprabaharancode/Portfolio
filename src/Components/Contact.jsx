    ...
    <div className='contact'>
      ...
      <div style={{margin:'50px 20px',display:'flex',gap:'20px'}}>
        <div style={{width:'50%'}} className='min'>
          ...
          <div style={{display:'flex',alignItems:'center',gap:'20px'}}><FaEnvelope size={30} /><p style={{color:'black',fontWeight:'bold'}}>www.tamilprabaharancivil@gmail.com</p></div>
          <div style={{display:'flex',alignItems:'center',gap:'20px'}}><FaPhone size={30}  /><p style={{color:'black',fontWeight:'bold'}}>+91 9597944372</p></div>
          <div style={{display:'flex',alignItems:'center',gap:'20px'}}><GoLocation size={30} /><p style={{color:'black',fontWeight:'bold'}}>6,thiruvalluvar nagar,velayuthampalayam,karur</p></div>
